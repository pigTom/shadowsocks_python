...
def parse_header(data):
    """
    根据地址类型解析数据中的地址
    :param data: 客户端地址协商的数据去掉了前面三个字节
    :return: 返回connecttype, addrtype, to_bytes(dest_addr), dest_port, header_length
    """
    # 地址类型
    addrtype = ord(data[0])
    dest_addr = None
